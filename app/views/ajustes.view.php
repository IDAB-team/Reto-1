...
<html lang="en">
    ...
    <main class="ajustesMain">
        ...
        <form action="index.php?controller=AjustesController&accion=editar" method="post" class="ajustesFormulario">
            ...
            <div class="ajustesFormularioGrupo">
                <label for="contraseña" class="ajustesLabel">Contraseña actual : </label>
                <div class="ajustesPasswordWrapper">
                    <input type="password" id="contraseña" name="contraseña" placeholder="***********" class="ajustesInput">
                    <span class="ajustesTogglePassword" onclick="togglePassword('contraseña', this)"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
