        ...
        <?php foreach($listaAnuncios as $anuncio): ?>
            <div class="misAnunciosAnuncioCard">
                <div class="misAnunciosImagen">
                    <img src="./<?= htmlspecialchars($anuncio['urlImagen']) ?>" alt="<?= htmlspecialchars($anuncio['nombreAnuncio']) ?>">
                </div>
                <div class="misAnunciosFecha">
                    <p>
                        <?= !empty($anuncio['fechaAnuncio'])
                            ? date('d/m/Y', strtotime($anuncio['fechaAnuncio']))
                            : 'Sin fecha' ?>
                    </p>
                </div>
                <div class="misAnunciosInfo">
                    <div class="misAnunciosDetalles">
                        <div class="misAnunciosTexto">
                            <h4><?= htmlspecialchars($anuncio['nombreAnuncio']) ?></h4>
                            <h5><?= htmlspecialchars($anuncio['userName']) ?></h5> 
                            <div class="desc">
                    ...
                    <div class="misAnunciosEdicion">
                        <div>
                            <a href="index.php?controller=EditarAnuncioController&id=<?= $anuncio['idAnuncio'] ?>" class="btnEditar">
                                <!-- icono editar -->
