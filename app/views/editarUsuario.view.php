...
<html lang="en">
    ...
    <main class="editarUsuarioMain">
        ...
        <form action="index.php?controller=EditarUsuarioController&accion=editar&email=<?= urlencode($_GET["email"]) ?>&usuario=<?= urlencode($_GET["usuario"]) ?>" method="post" class="ajustesFormulario">
