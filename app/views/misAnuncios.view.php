            ...
            <div class="misAnunciosAnuncioCard">
                ...
                <div class="misAnunciosInfo">
                    ...
                    <div class="misAnunciosEdicion">
                        <div>
                            <!-- Este link le pasa el id del anuncio a la página editar: -->
                            <a href="index.php?controller=EditarAnuncioController&id=<?=$anuncio->idAnuncio ?>" class="btnEditar"> <!--Falta pasar el ID del anuncio-->
                                <!-- icono editar -->
                        ...
                        <div>
                            <a href="index.php?controller=AnunciosController&accion=eliminar&anuncio=<?= $anuncio->id ?>">
                                <!-- icono eliminar -->
                                <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php include __DIR__ . '/layout/footer.php'; ?>
 <!--Script-->
  ...
  <script src="/app/assets/scripts/misAnuncios.js"></script>
  <script src="/app/assets/scripts/anuncios.js"></script>
</html>
